...
export default function Footer() {
  return (
    <footer className="bg-noir text-white">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3 mt-1">
              <SocialLink href="https://facebook.com/guineemakiti" label="Facebook — Guinée Makiti">
                <FacebookSVG />
              </SocialLink>
              <SocialLink href="https://instagram.com/guineemakiti" label="Instagram — @guineemakiti">
                <InstagramSVG />
              </SocialLink>
              <SocialLink href="https://tiktok.com/@guineemakiti" label="TikTok — @guineemakiti">
                <TikTokSVG />
              </SocialLink>
              <SocialLink href={`https://wa.me/${WA_NUMBER}`} label="WhatsApp — 620326981">
                <WhatsAppSVG />
              </SocialLink>
            </div>
          </div>
      ...
      {/* Barre verte bas de page */}
      <div className="bg-vert py-3 px-4 text-center">
        <p className="text-white font-semibold text-sm">
          📦 Livraison à Conakry &nbsp;•&nbsp; 💳 Paiement à la livraison
        </p>
      </div>
    </footer>
  );
